...
my_copy = my_list[:]  # actual copy of the list, i.e. makes a new one with the changes
my_copy.append("Ida")
print(my_copy)
print(my_list)
...
print(my_2d[1][0])  # counting always starts from 0
...
print(min(my_numlist))  # returns the lowest value from list
print(max(my_numlist))  # returns the highest value from list
...
# FOR EACH LOOP (works for a copy of the item)
for name in my_list:
    name = name + "!"
    print(name)
